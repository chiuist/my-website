...
for (const pathname of ["/styles.css", "/assets/og.png", "/downloads/DropEdge-Latest.dmg", "/downloads/DropEdge-Free-2.6.dmg", "/downloads/DropEdge-Free-2.1.dmg", "/downloads/DropEdge-Free-1.6-build12.dmg", "/updates/appcast.xml", "/updates/DropEdge-Free-2.6.md"]) {
...
for (const source of ["../dropedge/index.html", "../dropedge/en/index.html"]) {
  test(`canonical metadata and download link resolve to the product domain in ${source}`, () => {
    ...
    assert.equal(new URL(href, origin).href, origin + "/downloads/DropEdge-Free-2.6.dmg");
  });
}
